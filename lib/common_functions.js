...
module.exports.CreateOutTopic = function(nodename, dataId, service) {
    return nodename + "/" + dataId + "/" + service;
}

module.exports.Save = function(node, nodename, dataId, data) {
    var ctx = node.context().global;

    ctx.set(nodename + "/" + dataId, data);
}